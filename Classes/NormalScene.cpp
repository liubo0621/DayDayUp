...
bool Game::init()
{
    ...
    _visibleSize = Director::getInstance()->getVisibleSize();
     _rank=UserDefault::getInstance()->getIntegerForKey("rank",1);
    _isMove=false;
 ...
 *  @return 障碍物
 */
Sprite * Game::addSlideObstacle(std::string spriteName,Vec2 position){
 ...
 *  @return 返回精灵
 */
Sprite * Game::addStack(std::string spriteName,Vec2 anchorPoint,Vec2 position){
    auto obstacle=Sprite::create(spriteName);
    //储存到障碍物集合中
    _obstacles.pushBack(obstacle);
 ...
 *  @return 返回精灵
 */
Sprite * Game::addObstacle(std::string spriteName,Sprite * stack , cocos2d::Vec2 position){
    auto obstacle=Sprite::create(spriteName);
...
//*******************具体障碍物************************
//两侧滑动
void Game::obstacle1(double height,float t){
...
//两个长的 交叉
void Game::obstacle3(double height,float t){
    //两根桩
    ...
    //旋转精灵
    //左
    auto leftObstacleRotationLong1=addObstacle("obstacle_rotation_long.png",leftObstacle,
                                               Vec2(leftObstacle->getContentSize().width-15, leftObstacle->getContentSize().height/2));
    auto leftObstacleRotationLong2=addObstacle("obstacle_rotation_long.png", leftObstacle,
                                               Vec2(leftObstacle->getContentSize().width-15, leftObstacle->getContentSize().height/2));
    //右
    auto rightObstacleRotationLong1=addObstacle("obstacle_rotation_long.png",rightObstacle,
                                                Vec2(15, rightObstacle->getContentSize().height/2));
    auto rightObstacleRotationLong2=addObstacle("obstacle_rotation_long.png", rightObstacle,
                                                Vec2(15, rightObstacle->getContentSize().height/2));
    //旋转
...
//两个长的，60度
void Game::obstacle4(double height,float t){
    //两根桩
    auto leftObstacle=addStack("obstacle_bar.png", Vec2(0.3, 0.5), Vec2(0,height));
    auto rightObstacle=addStack("obstacle_bar.png", Vec2(0.7, 0.5), Vec2(_visibleSize.width, height));
    leftObstacle->setTag(STACK);
...
//两个长的 90度
void Game::obstacle5(double height,float t){
    //两根桩
    auto leftObstacle=addStack("obstacle_bar.png", Vec2(0.3, 0.5), Vec2(0,height));
    auto rightObstacle=addStack("obstacle_bar.png", Vec2(0.7, 0.5), Vec2(_visibleSize.width, height));
    leftObstacle->setTag(STACK);
...
//两个长的 顺时针旋转
void Game::obstacle6(double height,float t){
    //两根桩
    auto leftObstacle=addStack("obstacle_bar.png", Vec2(0.3, 0.5), Vec2(0, height));
    auto rightObstacle=addStack("obstacle_bar.png", Vec2(0.7, 0.5), Vec2(_visibleSize.width, height));
    leftObstacle->setTag(STACK);
    rightObstacle->setTag(STACK);
    //旋转精灵
    auto leftObstacleRotationLong=addObstacle("obstacle_rotation_long.png", leftObstacle,
                                              Vec2(leftObstacle->getContentSize().width-15, leftObstacle->getContentSize().height/2));
    auto rightObstacleRotationLong=addObstacle("obstacle_rotation_long.png", rightObstacle,
                                               Vec2(15, rightObstacle->getContentSize().height/2));
//    //旋转
    auto rotation=RepeatForever::create(RotateBy::create(t,360));
...
//两个长的 一顺一逆旋转
void Game::obstacle7(double height,float t){
    //两根桩
    auto leftObstacle=addStack("obstacle_bar.png", Vec2(0.3, 0.5), Vec2(0, height));
    auto rightObstacle=addStack("obstacle_bar.png", Vec2(0.7, 0.5), Vec2(_visibleSize.width, height));
    leftObstacle->setTag(STACK);
...
//两个长的，60度 旋转速度不一
void Game::obstacle8(double height,float t){
    //两根桩
    auto leftObstacle=addStack("obstacle_bar.png", Vec2(0.3, 0.5), Vec2(0,height));
    auto rightObstacle=addStack("obstacle_bar.png", Vec2(0.7, 0.5), Vec2(_visibleSize.width, height));
    leftObstacle->setTag(STACK);
...
//两个长的 一顺一逆旋转 速度不一
void Game::obstacle9(double height,float t){
    //两根桩
    auto leftObstacle=addStack("obstacle_bar.png", Vec2(0.3, 0.5), Vec2(0, height));
    auto rightObstacle=addStack("obstacle_bar.png", Vec2(0.7, 0.5), Vec2(_visibleSize.width, height));
    leftObstacle->setTag(STACK);
...
//移动障碍物
void Game::moveObstacles(float delta){
...
//移除障碍物
void Game::removeObstacle(float delta){
    for (auto obstacle:_obstacles) {
        if (obstacle->getPosition().y<-_visibleSize.height/2) {
