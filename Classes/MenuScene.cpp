...
bool MenuScene::init() {
    ...
    this->runAction(
        Sequence::create(func1, delay, func2, delay, func3, delay, func4, delay, func5, delay, func6, func7, DelayTime::create(0.5), func01, delay2, func02, delay2, func03, delay2, func04, NULL));
